...
# code by FooBar167 - https://stackoverflow.com/questions/41656176/tkinter-canvas-zoom-move-pan
...
# filename = "./Input/alphabet-upper.png"  # place path to your image here
